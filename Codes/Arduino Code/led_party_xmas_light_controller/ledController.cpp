...
uint8_t LedCtrl::getState()
{
    // Return the state of the LED Controller.
    // 1 = Enabled, 0 = Disabled.
    return _enabled;
}

void LedCtrl::setMode(int8_t _mode)
{
...
void LedCtrl::speedChange(int8_t _percent)
{
    ...
    // Also send spped change to the melody controller.
    _melodyCtrlPtr->setTempoOffset(_percent);
}
